...
const changeAvatar = (avatar) => {
  const container = document.querySelector('.avatar__list')
  emit('avatar', `../../assets/avatar/avatar${avatar}.jpg`)
    ...
    <ul class="nav__settings">
      <li class="icon__display">
        <img
          ...
          :src="
            props.theme == 'dark'
              ? '../../assets/icons/dark/icon-grid1-dark.png'
              : '../../assets/icons/icon-grid1.png'
          "
          alt="display"
        />
        <img
          ...
          :src="
            props.theme == 'dark'
              ? '../../assets/icons/dark/icon-grid2-dark.png'
              : '../../assets/icons/icon-grid2.png'
          "
          alt="display"
        />
        <img
          ...
          :src="
            props.theme == 'dark'
              ? '../../assets/icons/dark/icon-flex-dark.png'
              : '../../assets/icons/icon-flex.png'
          "
        />
      </li>
      ...
      <li>
        <img
          ...
          class="img__avatar"
          :src="props.avatar == null ? '/../../assets/avatar/avatar1.jpg' : props.avatar"
          alt="avatar"
        />
      </li>
